    ...
    <div class="container">
        ...
        <section class="newBlog">
            <a href="#lastPost" class="title animated bounceIn">
                <p class="headline" id="lastPost">Latest</p>
            </a>
        ...
        <section class="contact">
            ...
            <div class="email animated fadeIn">
                <input type="text" placeholder=" theme" v-model="subject"/>
                <input type="text" placeholder=" ur email" v-model="address"/>
                <textarea placeholder=" say something 2 me..." spellcheck="false" v-model="content"></textarea>
                <button class="sendEmail" @click="send"  :disabled="sendFlag">
                    <span>{{sendFlag ? 'sending...' : 'SEND'}}</span>
                </button>
            </div>
        </section>
    </div>
