<template>
    <div id="contact">
        ...
        <div class="info animated tada">
            ...
            <div class="wraper">
                <p class="left">email:</p><p class="right">june20ru@gmail.com</p>
                <p class="left">QQ:</p><p class="right">503854937</p>
                <p class="left">school:</p><p class="right">Southeast university</p>
                <p class="left">resume:</p><a class="right" href="static/download/resume.pdf" download="">Click & download my resume</a>
            </div>
        </div>
    </div>
</template>
